      ...
      <div className="bg-white/80 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 rounded-3xl p-4 sm:p-6 space-y-4 no-print">
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap justify-end">
            <div className="flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-bold text-neutral-700 bg-white/90 border border-neutral-200/80 px-2.5 sm:px-4 h-9 sm:h-11 rounded-full shadow-xs">
              ...
              <strong className="text-orange-700">{totalPiecesCount}</strong>
            </div>
            ...
            <button
              ...
              className="bg-neutral-900 hover:bg-black text-white text-xs sm:text-sm font-bold h-9 sm:h-11 px-4 sm:px-6 rounded-full shadow-md flex items-center gap-1.5 sm:gap-2 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-50"
            >
